...
@amenity_views.route("/", methods=["GET"], strict_slashes=False)
def list_amenities():
...
@amenity_views.route("/<amenity_id>", methods=["GET"], strict_slashes=False)
...
@amenity_views.route("/", methods=["POST"], strict_slashes=False)
def create_amenity():
